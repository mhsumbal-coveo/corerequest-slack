const partnerRequest = (body, view, requestType, requestTypeText) => {
    return {
            ...
            blocks: [
                ...
                },
                {
                    ...
                    element: {
                        ...
                        "placeholder": {
            "type": "plain_text",
            "text": "Please include dates and times, the type of assistance needed (enablement, call, demo), if this is customer facing name the customer. "
        }
                    },
                    label: {
                        type: 'plain_text',
